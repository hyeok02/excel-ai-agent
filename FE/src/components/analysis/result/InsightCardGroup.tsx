  ...
  return (
    <>
      {group.insights.map((insight, index) => {
        ...
        return (
          <section aria-labelledby={headingId} className="flex min-w-0 flex-col" key={headingId}>
            <div className="mb-3">
              <h4 className="text-lg font-extrabold leading-7 text-slate-900" id={headingId}>
                {title}
              </h4>

...
from app.services.insights.ranked_aggregates import aggregate_candidates, quantity_label
from app.services.insights.ranked_regions import ranked_regions
...
from app.services.insights.table_schema import column, detect_schema, share_value
